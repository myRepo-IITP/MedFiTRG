#!/usr/bin/env python3
"""
Main script for training and testing the Readmission (REA) multimodal model.
Usage: python run_rea.py [--mode train|test|both] [--gpu GPU_ID] [--epochs NUM_EPOCHS] [--batch_size BATCH_SIZE]
"""
...
def parse_args():
    parser = argparse.ArgumentParser(description="Train/Test Readmission Multimodal Model")
...
def main():
    ...
    print(f"[TASK] Readmission (REA) Prediction - Binary Classification")
    ...
    if args.mode in ['train', 'both']:
        ...
        pos_weight, readmission_rate = calculate_class_weights(train_loader)
    ...
    if args.mode in ['test', 'both']:
        ...
        if args.mode == 'both':
            ...
            print(f"Readmission Rate in Training: {readmission_rate:.4f}")
        print(f"Test AUROC: {test_metrics['auroc']:.4f}")
        print(f"Test F1-Score: {test_metrics['f1_score']:.4f}")
        print(f"Readmission Prediction Performance Summary:")
        ...
        print(f"  Binary Classification: Readmission vs. No Readmission")
