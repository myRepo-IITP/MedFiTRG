...
@dataclass
class Config:
    """Configuration for Phenotype multimodal model"""
    # Data paths
    METADATA_DIR = ""
    EHR_BASE_DIR = ""  # preprocessed with Normalized EHR directory
    CXR_BASE_DIR = ""
    
    # Phenotype metadata files
    ...
    # Output
    MODEL_SAVE_PATH = "best_model_phe_global_temporal.pth"
    LOG_DIR = "logs_phe"
    RESULTS_PATH = "phenotype_results.csv"